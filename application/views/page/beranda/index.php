                ...
                <div class="row">
                        ...
                        <div class="about-two__content">
                            <div class="block-title text-left">
                                <h2 class="block-title__title">KEPALA SEKOLAH<br>
                                   SMKN 14 BANDUNG</h2><!-- /.block-title__title -->
                            </div><!-- /.block-title -->
                            <p class="about-two__text"style="text-align:justify">Nama : Drs. H. Agus Rustiadin, M.M.Pd<br>
														NIP : 19660331 199412 1 001<br>

                                Assalamu ‘alaikum wa rahmatullahi wa barakatuh,<br> SMKN 14 Kota Bandung adalah Sekolah Menengah Kejuruan yang memiliki bidang keahlian Seni Rupa, Kerajinan Kriya, TIK, serta Teknologi dan Rekayasa. SMKN 14 Kota Bandung Mempersiapkan lulusan yang berwawasan profesional, produktif, dan memiliki budaya kerja yang baik. Dengan Demikian SMKN 14 Kota Bandung siap menciptakan tamatan yang berkompeten sesuai dengan bidangnya.
                                </p><!-- /.about-two__text -->
                    ...
                    <div class="col-lg-6 d-flex justify-content-xl-end justify-content-sm-center">
                        <div class="about-two__image">
                            ...
                            <img src="assets/img/kepala_sekolah.jpg" alt="">
